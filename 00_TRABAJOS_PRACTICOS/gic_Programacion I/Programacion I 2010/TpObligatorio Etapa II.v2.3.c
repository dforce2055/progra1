...
void altaProducto(lista *pDada, listaPaises pLista, listaTipoProductos tLista)
{
	...
	while(salida==1)
	{
		...
		}while(((validarCodigo(nuevo->codigoBarras))==1) && (buscarCodigoBarras(*pDada, nuevo->codigoBarras))==1 && (validarCodigoPaisEnCodigoBarras==0) && (validarCodigoTipoProductoEnCodigoBarras)==0);
